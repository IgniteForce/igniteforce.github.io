...
// Console Easter Egg
console.log('%c🔥 IgniteForce 焱火擎光 🔥', 'font-size: 24px; font-weight: bold; color: #ff6b35;');
...
const updateCopyrightYear = () => {
    ...
    if (copyrightElement) {
        ...
        copyrightElement.innerHTML = `© 2024-${currentYear} IgniteForce. Igniting Innovation, Powering Excellence.`;
    }
};
